...
export default function App() {
  ...
  return (
    <View
      ...
      <Text>Token Expo Push: {expoPushToken}</Text>
...
async function registerForPushNotificationsAsync() {
  ...
  if (Device.isDevice) {
    ...
    if (finalStatus !== 'granted') {
      alert('Falha ao obter o Token Push para a notificação Push!');
      return;
    }
    token = (await Notifications.getExpoPushTokenAsync()).data;
    console.log(token);
  } else {
    alert('Deve se usar um dispositivo físico para que as Notificações Push funcionem corretamente!');
  }
